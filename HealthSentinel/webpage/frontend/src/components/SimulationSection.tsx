...
import { healthsenitalButton } from "./healthsenitalButton";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Watch healthsenital AI in action as it detects and blocks real-world cyber attacks in real-time.
          </p>
        </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-background/50 rounded-lg border border-accent/30">
                      ...
                      <div className="text-sm space-y-2">
                        <div><strong>From:</strong> ceo@healthsenital-security.com</div>
            ...
            <Card className="bg-gradient-cyber border-glow">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>healthsenital AI Response</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
